...
const playbooks = [
  ...
  { name: "Insider Data Exfil", steps: 9, runs: 47 },
  { name: "Cloud Misconfig Auto-Fix", steps: 5, runs: 211 },
];
  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: "Active Incidents", value: "2", icon: AlertCircle, tone: "critical" as const },
          { label: "MTTR", value: "32m", icon: Clock, tone: "default" as const },
          { label: "On-call", value: "3", icon: Users, tone: "default" as const },
          { label: "Closed (7d)", value: "18", icon: CheckCircle2, tone: "success" as const },
        ].map((s) => {
          const Icon = s.icon;
          const tone = {
