...
function LandingPage() {
  ...
  const ref = usePageReveal<HTMLDivElement>("landing");
  return (
    <div className="blue-site" ref={ref}>
      ...
      <main id="main-content">
        <section className="blue-hero">
          <div className="blue-hero-copy" data-reveal>
          ...
          <div className="blue-hero-earth" data-reveal>
            <EarthGlobe />
          </div>
        ...
        <section id="solutions" className="blue-section blue-container">
          <div className="blue-section-heading" data-reveal>
            ...
            <div className="blue-intro-row">
              ...
              <p>From understanding an alert to exploring a pattern, find the context you need.</p>
              <a href="#platform" className="blue-text-link">
        ...
        <section id="platform" className="blue-feature-section">
          <div className="blue-container blue-feature-layout">
            <div className="blue-phone-stage" data-reveal>
            ...
            <div className="blue-feature-copy" data-reveal>
              ...
              <div className="blue-accordion">
                {features.map(({ icon: Icon, title, description }, i) => (
                  <div className={`blue-feature-item ${active === i ? "active" : ""}`} key={title}>
                    <button
          ...
          <div className="blue-workspace-inner">
            ...
            <div className="blue-comparison-scroll" data-reveal>
              <table className="blue-comparison">
                <caption className="sr-only">Capabilities across Sentivoy workspace views</caption>
                <thead>
                  <tr>
            ...
            <div className="blue-try-layout">
              ...
              <div className="blue-try-phone" data-reveal>
